...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ilk_paket-msg:<FibonacciResult> is deprecated: use ilk_paket-msg:FibonacciResult instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ilk_paket-msg:sequence-val is deprecated.  Use ilk_paket-msg:sequence instead.")
  (sequence m))
